...
{
    public class When_saving_category : UsingCategoryControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _categoryService.Save(_category).Returns(_category);
            _mapper.Map<CategoryDto>(_category).Returns(_categoryDto);
        }
        public override void Because()
        {
            _result = subject.Save(_category);
        }

        [Test]
        public void Request_is_routed_through_service()
        {
            _categoryService.Received(1).Save(_category);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (CategoryDto)resultListObject;
